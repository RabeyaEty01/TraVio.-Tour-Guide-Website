            ...
            <div className="row container">
                <div className="col-lg-10 container">
                    <div className="animate__animated animate__bounceInLeft about-h2 ">
                        <h2 className="text-start w-50  mx-5 py-2"><small className="fw-bold ">Explore</small> <small className="text-secondary">the World </small> <br /> <small className="fw-bold">for Travel</small>
                        </h2>
                    </div>

                    <div className="animate__animated animate__bounceInLeft w3-panel w3-leftbar w3-light-grey">
                        <p className="w3-xlarge w3-serif mx-5  w-50 text-start"><i>"The world is a book and those who do not travel read only one page.Jobs fill your pockets, adventures fill your soul.The journey of a thousand miles begins with a single step.Travel is the only thing you buy that makes you richer"</i></p>
