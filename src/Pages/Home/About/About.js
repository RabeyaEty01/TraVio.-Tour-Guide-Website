    ...
    return (
        <div className="my-5 container">
            ...
            <div class="animate__animated animate__bounceInRight row mt-5">
                <div class="col-3">
                    <div class="row mb-3">
                        <img class="img-fluid" src="https://i.ibb.co/D9spmsZ/1.jpg" alt="" />
                    </div>
                    <div class="row">
                        <img src="https://i.ibb.co/rQxf17z/2.jpg" alt="" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="row mb-3">
                        <img class="img-fluid" src="https://i.ibb.co/s2nqZJN/4.jpg" alt="" />
                    </div>
                    <div class="row mb-3">
                        <img class="img-fluid" src="https://i.ibb.co/ccbqt5R/5.jpg" alt="" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="row mb-3">
                        <img src="https://i.ibb.co/YZzRqFy/9.jpg" alt="" />
                    </div>
                    <div class="row">
                        <img src="https://i.ibb.co/qD0S7dC/7.jpg" alt="" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="row mb-1">
                        <img className="img-fluid h-50" src="https://i.ibb.co/TmMD1HP/8.jpg" alt="" />
                    </div>
                    <div class="row mb-1">
